...
public class RedisLogServiceImpl implements RedisLogService {
    ...
    public void addLog(RedisLog redisLog) {
        try {
            ...
            redisUtil.expireWithJitter(logKey, EXPIRE_DAYS, java.util.concurrent.TimeUnit.DAYS);
            ...
            if (redisLog.getModule() != null) {
                ...
                redisUtil.expireWithJitter(moduleKey, EXPIRE_DAYS, java.util.concurrent.TimeUnit.DAYS);
            }
